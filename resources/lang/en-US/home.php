 ...
 *	On: Monday, 27-Jul-15 19:13:19 UTC
 *	Via web admin-interface from: 86.14.133.52
 */

return array (
  'safe_and_sustainable' => 'Safe &amp; Sound Organic Shopping<br>',
  'collect_bonets' => 'Collect Bonets<br>',
  'redeem_bonets' => 'Use Bonets<br>',
  'tabs' => 
  array (
    'purchase1' => 
    array (
      'body' => 'Need content to match picture',
      'title' => 'Need title to match picture',
    ),
    'purchase2' => 
    array (
      'body' => 'Need content to match picture',
    ...
    'collect_bonets1' => 
    array (
      'body' => 'For each purchase in the Avocado Store - Germany&#39;s biggest online store for sustainable products, eco-fashion and eco-lifestyle products - you&#39;ll get 2 Bonets as a reward.',
      'title' => '<a href="http://www.bonsum.de/shops?searchString=avocado+store" target="_blank">Avocadostore | 2 Bonets per &euro;</a>',
    ),
    'collect_bonets2' => 
    array (
      'body' => 'With everything from food to books and beauty products, Veganic is the online shop with everything a vegan (or would-be vegan!) could ever need ...',
      'title' => '<a href="http://www.bonsum.de/shops?searchString=veganic" target="_blank">Veganic | 3 Bonets per &euro;</a>',
    ),
    'redeem_bonets1' => 
    array (
      ...
      'title' => '<a href="http://www.bonsum.de/bonets-einloesen?mode=1" target="_blank">Donate to PETA, Caritas and many more</a>',
    ),
    'redeem_bonets2' => 
    array (
      'body' => 'Help Bonsum support reforestation in Germany. Every time you put your Bonets towards trees, we&#39;ll plant a tree in the Bonsum forest in your name.',
      'title' => 'Plant Trees in Germany or Brazil',
    ),
  ),
  ...
  array (
    'c0_name' => 'Lia',
    'c0_review' => '„Es gibt heute sehr viele tolle nachhaltige Alternativen zu herkömmlichem Konsum. <br /> Umso besser, wenn man für jeden Schritt in die richtige Richtung belohnt wird!“',
    'c1_name' => 'Carl-Christian',
    'c1_review' => '„Mir gefällt besonders gut, dass ich selbst entschieden kann, was ich mit meinen Bonets mache. Spenden oder einlösen eben.“',
    'c2_name' => 'Sabrina',
    'c2_review' => '&quot;I love that I no longer have to research endlessly. I&#39;ve discovered so many cool new shops!&quot;',
    'c3_name' => 'Franziska',
    'c3_review' => '&quot;I&#39;ve always shopped on Amazon for convenience, though I really don&#39;t like doing so. Finally, I no longer have to!&quot;',
  ),
  'brands' => 
  array (
    'title' => 'What Corporate Customers Say',
